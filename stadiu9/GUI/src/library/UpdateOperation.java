...
public class UpdateOperation extends ConcreteOperation{
    ...
    public String updateBookByTitleAndAuthor(String targetData, String updatedTitle, String updatedAuthor, 
    		String[] updatedKeywords, int updatedYear, String[] updatedDomains, String updatedPublisher) 
    {
        ...
        try {
        	...
        	{
        		return "A book with the same author and title already exists!";
        	}
        	else
        	{

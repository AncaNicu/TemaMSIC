...
public class SearchOperation extends ConcreteOperation{
	...
	//constante pentru mesajele returnate de fct pt cautare
    private static final String SEARCH_ERROR_PREFIX = "Search Error: ";
    private static final String CHECK_CONSOLE_MESSAGE = "Check the console for results!";
	
    //pt a cauta o carte dupa autor
    public String searchBooksByAuthor(String searchedAuthor)
    {
        ...
        try {
            ...
            {
            	return "There is no book written by " + searchedAuthor + "!";
            }
            else
            {
            	displaySearchedBooks(matchingBooks);
            	return CHECK_CONSOLE_MESSAGE;
            }
            
        } catch (Exception e) {
            return SEARCH_ERROR_PREFIX + e.getMessage();
        }
        
    }
    
    //pt a cauta o carte dupa editura
    public String searchBooksByPublisher(String searchedPublisher)
    {
        ...
        try {
            ...
            if(matchingBooks.isEmpty())
            {
            	return "There is no book published by " + searchedPublisher + "!";
            }
            else
            {
            	displaySearchedBooks(matchingBooks);
    ...
    public String searchBooksBetweenYears(int year1, int year2)
    {
        ...
        try {
            ...
            if(matchingBooks.isEmpty())
            {
            	return "There is no book published between " + year1 + " and " + year2 + "!";
            }
            else
            {
            	displaySearchedBooks(matchingBooks);
    ...
    public String searchBooksByKeywords(String[] searchedKeywords)
    {
        ...
        try {
            ...
            if(matchingBooks.isEmpty())
            {
            	return "There is no book that has any of the searched keywords!";
            }
            else
            {
            	displaySearchedBooks(matchingBooks);
    ...
    public String searchBooksByDomain(String searchedDomain)
    {
    	//lista de carti care au acel autor
    	List<Element> matchingBooks = new ArrayList<>();
        try {
            ...
            if(matchingBooks.isEmpty())
            {
            	return "There is no " + searchedDomain + " book!";
            }
            else
            {
            	displaySearchedBooks(matchingBooks);
